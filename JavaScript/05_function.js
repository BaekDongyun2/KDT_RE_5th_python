...
myFunc("콘솔에 찍히지 않음"); // console.log() 사용하지 않았음
console.log(myFunc("이렇게 해야 정상적으로 콘솔에 찍힘"));
...
myFunc2("이렇게 호출만 해도 콘솔에 찍혀야 함");

// 1-2. 함수 표현식
// 변수에 익명함수를 할당하는 방법
const myFunc3 = function () {
    console.log('이렇게 함수 표현식으로 함수를 선언할 수 있음');
};
...
const arrowFunc = () => {
    ...
    return '이렇게 화살표 함수를 사용할 수 있음';
};

// 한 줄로 작성 + 괄호 없는 경우에는 해당 내용을 자동으로 return
const arrowFunc2 = () => '이렇게 쓸 수도 있음';
arrowFunc2();
